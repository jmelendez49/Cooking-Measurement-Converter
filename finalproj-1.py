...
def openWindow2():
    ...
    # Function to check if value is a integer, and not letters.
    def number():
        try:
            float(entry.get())
        except ValueError:
            messagebox.showinfo(title = None, message = "Value has to be a number!",)
    ...
    button1 = tk.Button(window2, text = "Cups to Ounces",
            command = lambda: [number(), CupTOounces()],     
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button2 = tk.Button(window2, text = "Ounces to Cups",
            command = lambda: [number(), OuncesTOcups()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button4 = tk.Button(window2, text = "Milliliters to Cups",
            command = lambda: [number(), MlTOcups()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button5 = tk.Button(window2, text = "Tablespoons to Grams",
            command = lambda: [number(), TableTOgrams()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button6 = tk.Button(window2, text = "Grams to Tablespoons",
            command = lambda: [number(), GramsTOtable()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button7 = tk.Button(window2, text = "Teaspoons to Grams",
            command = lambda: [number(), TeaTOgrams()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
    ...
    button8 = tk.Button(window2, text = "Grams to Teaspoons",
            command = lambda:  [number, GramsTOtea()],           
            fg = "white",
            bg = "#FF7D75",
            height = "2",
            width = "20",
